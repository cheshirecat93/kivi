  ...
  <div class="col-12">
    ...
    <form method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="name" name="name" required placeholder="Nosaukums" value="<?php echo $friend_add_form_values['name']; ?>">
      </div>
      <div class="form-group">
        <label for="url">Saite</label>
        <input type="text" class="form-control" id="url" name="url" placeholder="Saite" value="<?php echo $friend_add_form_values['url']; ?>">
      </div>
